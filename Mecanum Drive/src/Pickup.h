...
public:
	Pickup(Talon &grabTalonPtr, Switch &grabInnerLimit, Switch &grabOuterLimit, Talon &liftTalon, Encoder &liftEncoder, Switch &liftInnerLimit, Switch &liftOuterLimit, PowerDistributionPanel &pdpPtr);
